...
class TestNiftyAdminScaffoldGenerator < Test::Unit::TestCase
  ...
  context "routed" do
    ...
    context "generator without name" do
      should "raise usage error" do
        assert_raise Rails::Generator::UsageError do
          run_rails_generator :nifty_admin_scaffold
        end
      end
    end
  
    context "generator with no options and no existing model" do
      rails_generator :nifty_admin_scaffold, "LineItem"
      ...
      should "generate controller with class as camelcase name pluralized and all actions" do
        assert_generated_file "app/controllers/admin/line_items_controller.rb" do |body|
      ...
      %w[index show new edit].each do |action|
        should_generate_file "app/views/admin/line_items/#{action}.html.erb"
      end
    
      should "have name attribute" do
        assert_generated_file "app/views/admin/line_items/_form.html.erb" do |body|
    ...
    context "generator with some attributes" do
      rails_generator :nifty_admin_scaffold, "line_item", "name:string", "description:text"
    ...
    context "generator with index action" do
      rails_generator :nifty_admin_scaffold, "line_item", "index"
    
      should_generate_file "app/views/admin/line_items/index.html.erb"
    ...
    context "generator with show action" do
      rails_generator :nifty_admin_scaffold, "line_item", "show"
    
      should_generate_file "app/views/admin/line_items/show.html.erb"
    ...
    context "generator with new and create actions" do
      rails_generator :nifty_admin_scaffold, "LineItem", "new", "create"
    
      should_not_generate_file "app/views/admin/line_items/create.html.erb"
      should_not_generate_file "app/views/admin/line_items/_form.html.erb"
    
      should "render form in 'new' template" do
        assert_generated_file "app/views/admin/line_items/new.html.erb" do |body|
    ...
    context "generator with edit and update actions" do
      rails_generator :nifty_admin_scaffold, "line_item", "edit", "update"
    
      should_not_generate_file "app/views/admin/line_items/update.html.erb"
      should_not_generate_file "app/views/admin/line_items/_form.html.erb"
    
      should "render form in 'edit' template" do
        assert_generated_file "app/views/admin/line_items/edit.html.erb" do |body|
          assert_match "<%= form_for @line_item do |f| %>", body
        end
      end
    ...
    context "generator with edit and update actions" do
      rails_generator :nifty_admin_scaffold, "line_item", "destroy"
    
      should_not_generate_file "app/views/admin/line_items/destroy.html.erb"
    ...
    context "generator with new and edit actions" do
      rails_generator :nifty_admin_scaffold, "line_item", "new", "edit"
    
      should_generate_file "app/views/admin/line_items/_form.html.erb"
    
      should "render the form partial in views" do
        %w[new edit].each do |action|
          assert_generated_file "app/views/admin/line_items/#{action}.html.erb" do |body|
    ...
    context "generator with attributes and actions" do
      rails_generator :nifty_admin_scaffold, "line_item", "name:string", "new", "price:float", "index", "available:boolean"
    ...
    context "generator with show, create, and update actions" do
      rails_generator :nifty_admin_scaffold, "line_item", "show", "create", "update"
    ...
    context "generator with attributes and skip model option" do
      rails_generator :nifty_admin_scaffold, "line_item", "foo:string", :skip_model => true
    ...
    context "generator with no attributes" do
      rails_generator :nifty_admin_scaffold, "line_item"
    ...
    context "generator with exclemation mark and show, new, and edit actions" do
      rails_generator :nifty_admin_scaffold, "line_item", "!", "show", "new", "edit"
    ...
    context "generator with --skip-controller" do
      rails_generator :nifty_admin_scaffold, "line_item", :skip_controller => true
      should_not_generate_file "app/controllers/admin/line_items_controller.rb"
      should_not_generate_file "app/helpers/line_items_helper.rb"
      should_not_generate_file "app/views/admin/line_items/index.html.erb"
    end
    
    context "generator with --skip-migration" do
      rails_generator :nifty_admin_scaffold, "line_item", "name:string", :skip_migration => true
    ...
    context "generator with --skip-timestamps" do
      rails_generator :nifty_admin_scaffold, "line_item", "name:string", :skip_timestamps => true
    ...
    context "generator with --make-fixture" do
      rails_generator :nifty_admin_scaffold, "line_item", "name:string", :make_fixture => true
    ...
    context "existing model" do
      ...
      context "generator with skip model option" do
        rails_generator :nifty_admin_scaffold, "recipe", :skip_model => true
    
        should "use model columns for attributes" do
          assert_generated_file "app/views/admin/recipes/_form.html.erb" do |body|
            assert_match "<%= f.text_field :foo %>", body
      ...
      context "generator with attribute specified" do
        rails_generator :nifty_admin_scaffold, "recipe", "zippo:string"
    ...
    context "with spec dir" do
      ...
      context "generator with new and index actions" do
        rails_generator :nifty_admin_scaffold, "line_item", "new", "index"
      ...
      context "generator with edit and index actions" do
        rails_generator :nifty_admin_scaffold, "line_item", "edit", "index"
      ...
      context "generator with testunit specified" do
        rails_generator :nifty_admin_scaffold, "line_item", "name:string", :test_framework => :testunit
    ...
    context "with test dir" do
      ...
      context "generator with rspec specified" do
        rails_generator :nifty_admin_scaffold, "line_item", "name:string", :test_framework => :rspec
        
        should_generate_file "spec/models/line_item_spec.rb"
      end
      
      context "generator with shoulda specified" do
        rails_generator :nifty_admin_scaffold, "line_item", "name:string", :test_framework => :shoulda
    ...
    context "generator with haml option" do
      rails_generator :nifty_admin_scaffold, "LineItem", :haml => true
      
      %w[index show new edit _form].each do |action|
        should_generate_file "app/views/admin/line_items/#{action}.html.haml"
      end
    
      should "render the form partial in views" do
        %w[new edit].each do |action|
          assert_generated_file "app/views/admin/line_items/#{action}.html.haml" do |body|
            assert_match /^= render :partial => 'form'$/, body
          end
        end
      end
